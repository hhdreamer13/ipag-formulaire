...
const PersonalConferencierForm = () => {
  ...
  const schema = yup.object({
    ...
    tel: yup
      ...
      .min(10, "Le numéro de téléphone doit comporter plus de chiffres")
      .max(17, "Le numéro de téléphone doit contenir moins de 12 chiffres"),
    diplomePlus: yup
      .string()
      .required("Ce champ est obligatoire")
      .max(50, "Le texte ne peut pas dépasser 50 caractères"),
...
export default PersonalConferencierForm;
